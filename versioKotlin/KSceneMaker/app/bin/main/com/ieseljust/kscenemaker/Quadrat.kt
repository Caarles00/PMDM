...
class Quadrat: Figura {
    ...
    constructor(x: Int, y:Int, width:Int=100, color:Color=Color.BLACK): super(x, y, color) {
        //super(x, y, color)
        this.width=width
    ...
    override fun render(g:Graphics) {
        ...
        g.fillRect(x, y , width, width)    // Dibuixem un quadrat en la posició i mida indicades
    }
