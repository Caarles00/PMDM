            ...
            "cercle" -> {
                try{
                    ...
                    val color=figura[4]
                        ...
                        // Si tot és correcte creem la figura rectangle
                    var nouCerc = Cercles(x, y, r, this.getColor(color))
                    // I l'afegim a la llista
                    escena.add(nouCerc)
                } catch (err:Exception){
                    println("\u001B[31m Arguments incorrectes \u001B[0m");
            ...
            "elipse" -> {
                try{
                    ...
                    val color=figura[5]
                        ...
                        // Si tot és correcte creem la figura rectangle
                    var nouElip = Elipses(x, y, r, r2, this.getColor(color))
                    // I l'afegim a la llista
                    escena.add(nouElip)
                } catch (err:Exception){
                    println("\u001B[31m Arguments incorrectes \u001B[0m");
            ...
            "quadrat" -> {
                try{
                    ...
                    val color=figura[4]
                        ...
                        // Si tot és correcte creem la figura rectangle
                    var nouQuad = Quadrat(x, y, w, this.getColor(color))
                    // I l'afegim a la llista
                    escena.add(nouQuad)
                } catch (err:Exception){
                    println("\u001B[31m Arguments incorrectes \u001B[0m");
            ...
            "linia" -> {
                try{
                    ...
                    val color=figura[5]
                        ...
                        // Si tot és correcte creem la figura rectangle
                    var nouLinia = Linies(x, y, w, h, this.getColor(color))
                    // I l'afegim a la llista
                    escena.add(nouLinia)
                } catch (err:Exception){
                    println("\u001B[31m Arguments incorrectes \u001B[0m");
